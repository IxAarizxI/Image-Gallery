...
class ImageGallery:
    def __init__(self, root):
        ...
        # Buttons
        self.buttonImport = tk.Button(root, text="Import Image Folder", command=self.load_folder, bg="white")
        ...
        self.buttonNext.pack(side=tk.RIGHT, padx=20, pady=20, fill=tk.X)
